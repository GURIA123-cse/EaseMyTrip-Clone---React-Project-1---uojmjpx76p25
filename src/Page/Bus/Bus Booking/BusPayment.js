...
function BusPayment() {
  ...
  const { fare, bookingId, bookingType,selectedSeats ,travelare} = useAuth();
  ...
  return (
    <div>
      ...
      <div className="w-[100%] h-[100%] bg-[#e8f2fa] flex justify-center">
        <div className=" w-[90%] h-[100%] max-[600px]:flex-col flex flex-row gap-[20px] justify-between mb-[20px]">
